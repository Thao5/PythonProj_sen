...
class CF(object):
    def __init__(self, data_matrix=pd.DataFrame(dataset2['train']), k=4, dist_func=cosine_similarity, uuCF=1):
    ...
    def write_sentiment_to_rec(self, s, sen, idThucAn, idNguoiDung):
        ...
        # Append new data
        df_combined = pd.concat([self.data_matrix, df_new], ignore_index=True)
